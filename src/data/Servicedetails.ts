...
export const serviceDetails: Record<Language, Record<ServiceId, ServiceDetail>> = {
  en: {
    webDesign: {
      ...
      benefits: [
        "A website enables constant presence on the internet, which means that potential clients can view your business and contact you at any time.",
        "With a website, you are easily accessible and visible to clients from all over the world, regardless of location.",
        "With a well-designed website, brand recognition increases and a professional image is created.",
        "The website serves as a central source of all the information, services, and products you offer. It is your home on the internet.",
      ],
